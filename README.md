...
- [SkillWorks](https://skillworks.thecompound.tech) - Every Claude Code skill, subagent, plugin and marketplace repo we can find, each with a published 0–100 score for whether it actually loads.
